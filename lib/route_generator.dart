...
import 'src/pages/view_markets.dart';
...
import 'src/pages/order_anything.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/Settings':
        return MaterialPageRoute(builder: (_) => SettingsWidget(routeArgument: args));
      case '/viewMarketsByCategory':
        //print(args);
        return MaterialPageRoute(builder: (_) => ViewMarketsByField(routeArgument: args ));
      case '/OrderAnything':
        //print(args);
        return MaterialPageRoute(builder: (_) => OrderAnything( ));
      default:
