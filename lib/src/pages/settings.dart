...
class SettingsWidget extends StatefulWidget {
  ...
  SettingsWidget({this.routeArgument});
...
class _SettingsWidgetState extends StateMVC<SettingsWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    // Scaffold.of(context).showSnackBar(SnackBar(content: widget.routeArgument));}
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        child: Center(child: Text('متابعة',style: TextStyle(color: Colors.white ,fontSize: 25),)),),
                    ),
