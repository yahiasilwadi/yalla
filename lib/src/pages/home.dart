...
import '../elements/GridViewOfMainFields.dart';
...
class _HomeWidgetState extends StateMVC<HomeWidget> {
  //FieldController _conF = FieldController();
...
//DeliveryAddressesController dController = DeliveryAddressesController();

  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    //_conF.listenForFields();
    _productController.listenForProducts();
    getAddres();

    //  dController.listenForAddresses();
  }

  bool x = true;

  getAddres() async {
    Address b = await settingsRepo.getCurrentLocation();
    if (b.latitude == null) {
      x = true;
      return true;
    } else {
  ...
  Widget build(BuildContext context) {
    // getAddres();
    //dController.listenForAddresses();
    //print(dController.addresses.length);
    return Scaffold(
      appBar: AppBar(
              ...
              /*InkWell(
                onTap: () {
                  if (currentUser.value.apiToken == null) {
                    print('request for current location');
                    print('request for current location');
              ...
              Column(
                ...
                children: List.generate(
                  ...
                  switch (_homeSection) {
                    ...
                    case 'field_grid_view':
                      return Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 20),
                        child: GridViewOfMainFields(
                          fields: _con.fields,
                        ),
                      );
                    default:
