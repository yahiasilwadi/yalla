...
class CheckoutController extends CartController {
  ...
  void addOrder(
    ...
    _order.tax = 0; //carts[0].product.market.defaultTax;
    ...
    _order.hint = ' ';
    _order.couponUsed = settingRepo.coupon.code == null ||
            settingRepo.coupon.code.trim().isEmpty
        ? 'No coupon used'
        : 'discount: ${settingRepo.coupon.discount} - coupon code: ${settingRepo.coupon.code}';
